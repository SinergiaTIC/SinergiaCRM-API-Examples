...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .card{background:#fff;max-width:450px;width:100%;margin:20px;border-radius:8px;box-shadow:0 2px 12px rgba(0,0,0,.1);padding:40px;text-align:center}
        h1{font-size:22px;margin-bottom:10px;color:#1976d2}
        p{font-size:14px;color:#666;margin-bottom:25px;line-height:1.6}
        .btn{display:inline-block;padding:14px 32px;background:#1976d2;color:#fff;border:none;border-radius:6px;font-size:15px;font-weight:600;text-decoration:none;cursor:pointer}
        .btn:hover{background:#1565c0}
        .info{margin-top:20px;padding:12px;background:#e3f2fd;border-radius:6px;font-size:12px;color:#555;text-align:left}
        code{background:#bbdefb;padding:1px 5px;border-radius:3px;font-size:11px;word-break:break-all}
    </style>
</head>
<body>
<div class="card">
